;;; clay-moonlight-theme.el --- reference copy of Doom Moonlight -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup clay-moonlight-theme nil
  "Options for the `clay-moonlight' theme."
  :group 'doom-themes)

(defcustom clay-moonlight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'clay-moonlight-theme
  :type '(choice integer boolean))

;;
(def-doom-theme clay-moonlight
  ...
  ((bg         '("#212337" "#212337"  "black"))
   ...
   (-modeline-pad
    (when clay-moonlight-padded-modeline
      (if (integerp clay-moonlight-padded-modeline) clay-moonlight-padded-modeline 4))))
...
;;; clay-moonlight-theme.el ends here
