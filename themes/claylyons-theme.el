;;; claylyons-theme.el --- inspired by VS code's Moonlight -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup claylyons-theme nil
  "Options for the `claylyons' theme."
  :group 'doom-themes)

(defcustom claylyons-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'claylyons-theme
  :type '(choice integer boolean))

;;
(def-doom-theme claylyons
  ...
  ((bg         '("#212337" "#212337"  "black"))
   ...
   (base8      '("#b4c2f0" "#b4c2f0" "brightblue")) ;; was white
   (indigo     '("#7a88cf" "#7a88cf" "brightblack"))
   (region     '("#383e5c" "#383e5c" "brightblack"))
   (fg         '("#c8d3f5" "#c8d3f5" "green")) ;; was brightwhite
   (fg-alt     '("#b4c2f0" "#b4c2f0" "brightyellow")) ;;  was white

   (grey base5)

   (dark-red      '("#ff5370" "#ff5370" "red"))
   (red           '("#f07570" "#0f757f" "red"))
   ...
   (selection      region)
   (builtin        teal) ;; was magenta
   (comments       blue) ;; was indigo
   (doc-comments   (doom-lighten comments 0.25))
   (constants      orange)
   (functions      light-blue)
   (keywords       red) ;; was magenta
   (methods        red)
   (operators      dark-cyan)
   (type           yellow)
   (strings        green)
   ...
   (-modeline-pad
    (when claylyons-padded-modeline
      (if (integerp claylyons-padded-modeline) claylyons-padded-modeline 4))))
  ...
  ((font-lock-keyword-face :foreground keywords)
   ...
   (lazy-highlight :background base4 :foreground pink)
