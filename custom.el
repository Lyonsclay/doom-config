(custom-set-variables
 ...
 '(sql-connection-alist
   '(("gorge" (sql-product 'postgres) (sql-user "admin") (sql-database "gorge")
      (sql-password "*****") (sql-server "postgresql://postgres@127.0.01:5432"))))
